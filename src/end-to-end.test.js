...
it("produces correct link for view before & after go is pressed", async () => {
  ...
  const expectedLinkBRCA1 =
    "http://localhost?tracks=%5Bobject+Object%5D%2C%5Bobject+Object%5D%2C%5Bobject+Object%5D%2C%5Bobject+Object%5D&name=snp1kg-BRCA1&graphFile=snp1kg-BRCA1.vg.xg&gamFile=NA12878-BRCA1.sorted.gam&dataPath=default&region=17%3A1-100&bedFile=snp1kg-BRCA1.bed&dataType=built-in";
  // Set up dropdown
  await act(async () => {
    let dropdown = document.getElementById("dataSourceSelect");
    await userEvent.selectOptions(
  ...
  const expectedLinkCactus =
    "http://localhost?tracks=%5Bobject+Object%5D%2C%5Bobject+Object%5D%2C%5Bobject+Object%5D%2C%5Bobject+Object%5D&name=cactus&region=ref%3A1-100&dataPath=mounted&dataType=built-in";
